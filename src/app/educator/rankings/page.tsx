...
function RankingsInner() {
  ...
  return (
    <Shell tabs={tabs}>
      {classId && (
        <Link href={`/educator/classes/${classId}`} className="inline-flex items-center gap-1 mb-4 text-sm text-purple-700 hover:text-purple-900 hover:underline">← Back to class dashboard</Link>
      )}
      {/* Hero header */}
