...
// === CLASSES ===
export type Klass = { id: string; owner_id: string; name: string; description: string | null; color: string | null; join_code: string; is_archived: boolean; ended_at: string | null; created_at: string; scoring_mode?: 'team' | 'individual'; leaderboard_visible?: boolean };
