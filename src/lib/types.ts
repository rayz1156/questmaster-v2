...
export type Profile = { id: string; role: Role; display_name: string | null; suspended: boolean; approved: boolean; logo_url: string | null; bio: string | null; avatar_url: string | null; bio_updated_at: string | null; intro_display_name: string | null; intro_media_type: "image" | "video" | null; intro_image_file_code: string | null; intro_video_adilo_file_id: string | null; intro_video_adilo_project_id: string | null; intro_video_thumbnail_url: string | null; intro_video_duration_seconds: number | null; intro_media_updated_at: string | null; username: string | null; is_active: boolean; username_updated_at: string | null; created_at: string; max_classes_owned: number | null; max_classes_as_coeducator: number | null; plan?: 'free' | 'pro'; max_quizzes_owned?: number | null; max_live_players?: number | null; can_upload_files?: boolean; can_upload_videos?: boolean };
