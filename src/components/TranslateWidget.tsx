  ...
  return (
    <>
      ...
      <div
        ...
        style={{ position: "fixed", bottom: "20px", left: "16px", zIndex: 50 }}
      />
      {/* Fallback visual hint while script loads */}
      {!mounted && (
        <button
          aria-label="Translate (loading)"
          className="fixed bottom-5 left-4 z-40 rounded-full bg-white shadow-lg border border-gray-200 p-2 opacity-70"
          disabled
        >
